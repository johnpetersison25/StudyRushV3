...
public class EnglishQ : MonoBehaviour
{
    ...
    public static bool EnglishQuizIsDone = false;
  ...
  //=========================================================================
    ...
    {
        scoreText.text = "Score: " + EnglishScore.ToString();
    }
    ...
    void ShowResult()
    {
        ...
        resultScoreText.text = + EnglishScore + " / " + quizQuestions.Length;
    }
