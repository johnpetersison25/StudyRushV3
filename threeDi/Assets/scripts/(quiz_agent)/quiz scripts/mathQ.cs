...
public class mathQ : MonoBehaviour
{
    ...
    public static bool mathQuizIsDone = false;
  ...
  //=========================================================================
    ...
    {
        scoreText.text = "Score: " + mathScore.ToString();
    }
    ...
    void ShowResult()
    {
        ...
        resultScoreText.text = + mathScore + " / " + quizQuestions.Length;
    }
